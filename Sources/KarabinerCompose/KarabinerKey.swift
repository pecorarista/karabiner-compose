...
public struct KarabinerKey: Hashable, Sendable, ExpressibleByStringLiteral {
    ...
    private static let symbolMap: [String: KarabinerKey] = {
        ...
        map["("] = .modified("(", keyCode: "9", mandatoryModifiers: ["left_shift"])
        ...
        map["<"] = .modified("<", keyCode: "comma", mandatoryModifiers: ["left_shift"])
        ...
        map[">"] = .modified(">", keyCode: "period", mandatoryModifiers: ["left_shift"])
